...
[`pr-followup`](../pr-followup/SKILL.md) step 2 is the wired caller. That step's own procedure —
...
A pull request number, from [`pr-followup`](../pr-followup/SKILL.md) step 2.
...
[`investigate-scenario-flakiness`](../investigate-scenario-flakiness/SKILL.md):

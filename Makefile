...
DOCSTRING_PATHS := bajutsu/common/ai bajutsu/common/drivers/base.py bajutsu/common/drivers/actuation.py bajutsu/common/drivers/coordinate_tree.py bajutsu/common/drivers/fake.py bajutsu/common/drivers/xcuitest.py bajutsu/common/drivers/adb.py bajutsu/common/drivers/playwright.py bajutsu/common/drivers/xcuitest_live.py bajutsu/common/assertions bajutsu/common/evidence/network.py bajutsu/common/runner bajutsu/common/scenario bajutsu/mcp bajutsu/cli bajutsu/common/doctor.py bajutsu/analysis/audit.py bajutsu/analysis/coverage.py bajutsu/analysis/stats.py bajutsu/analysis/trace.py bajutsu/triage/heuristic.py bajutsu/common/report bajutsu/common/evidence/core.py bajutsu/common/evidence/intervals.py bajutsu/common/evidence/redaction.py bajutsu/common/config bajutsu/common/config_source.py bajutsu/codegen/xcuitest.py bajutsu/codegen/common.py bajutsu/codegen/playwright.py bajutsu/common/backends.py bajutsu/common/capability/capability_preflight.py bajutsu/common/provisioning/requirements.py bajutsu/common/provisioning/provision.py bajutsu/crawl/core.py bajutsu/crawl/serialize.py bajutsu/crawl/guide.py bajutsu/crawl/tabs.py bajutsu/common/agents/protocols.py bajutsu/common/agents/factory.py bajutsu/common/agents/claude.py bajutsu/common/agents/claude_backed.py bajutsu/common/agents/claude_triage.py bajutsu/common/agents/alerts.py bajutsu/common/agents/ai_config.py bajutsu/common/agents/anthropic_client.py bajutsu/record/loop.py bajutsu/common/screenshots.py bajutsu/common/evidence/visual.py bajutsu/common/drivers/web_network.py bajutsu/common/report/from_grouping.py

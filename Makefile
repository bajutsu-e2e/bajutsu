...
DOCSTRING_PATHS := bajutsu/ai bajutsu/drivers bajutsu/assertions bajutsu/evidence/network.py bajutsu/runner bajutsu/scenario bajutsu/mcp bajutsu/cli bajutsu/doctor.py bajutsu/analysis/audit.py bajutsu/analysis/coverage.py bajutsu/analysis/stats.py bajutsu/trace.py bajutsu/triage.py bajutsu/report bajutsu/evidence/core.py bajutsu/evidence/intervals.py bajutsu/evidence/redaction.py bajutsu/common/config bajutsu/common/config_source.py bajutsu/codegen/xcuitest.py bajutsu/codegen/common.py bajutsu/codegen/playwright.py bajutsu/backends.py bajutsu/common/capability/capability_preflight.py bajutsu/common/provisioning/requirements.py bajutsu/common/provisioning/provision.py bajutsu/crawl/core.py bajutsu/crawl/serialize.py bajutsu/crawl/guide.py bajutsu/crawl/tabs.py bajutsu/agents/protocols.py bajutsu/agents/factory.py bajutsu/agents/claude.py bajutsu/agents/claude_backed.py bajutsu/agents/claude_triage.py bajutsu/agents/alerts.py bajutsu/agents/ai_config.py bajutsu/agents/anthropic_client.py bajutsu/record.py bajutsu/screenshots.py bajutsu/evidence/visual.py bajutsu/web_network.py bajutsu/from_grouping.py

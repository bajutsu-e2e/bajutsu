...
DOCSTRING_PATHS := bajutsu/common/ai bajutsu/drivers bajutsu/common/assertions bajutsu/common/evidence/network.py bajutsu/runner bajutsu/common/scenario bajutsu/mcp bajutsu/cli bajutsu/doctor.py bajutsu/analysis/audit.py bajutsu/analysis/coverage.py bajutsu/analysis/stats.py bajutsu/trace.py bajutsu/triage.py bajutsu/common/report bajutsu/common/evidence/core.py bajutsu/common/evidence/intervals.py bajutsu/common/evidence/redaction.py bajutsu/config bajutsu/config_source.py bajutsu/codegen/xcuitest.py bajutsu/codegen/common.py bajutsu/codegen/playwright.py bajutsu/backends.py bajutsu/capability_preflight.py bajutsu/requirements.py bajutsu/provision.py bajutsu/crawl/core.py bajutsu/crawl/serialize.py bajutsu/crawl/guide.py bajutsu/crawl/tabs.py bajutsu/common/agents/protocols.py bajutsu/common/agents/factory.py bajutsu/common/agents/claude.py bajutsu/common/agents/claude_backed.py bajutsu/common/agents/claude_triage.py bajutsu/common/agents/alerts.py bajutsu/common/agents/ai_config.py bajutsu/common/agents/anthropic_client.py bajutsu/record.py bajutsu/screenshots.py bajutsu/common/evidence/visual.py bajutsu/web_network.py bajutsu/common/report/from_grouping.py

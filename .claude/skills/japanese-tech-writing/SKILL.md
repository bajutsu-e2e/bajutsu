...
[`english-tech-writing`](../english-tech-writing/SKILL.md) がある。日本語の散文を書くときは
`tech-writing` と本スキルの両方を適用し、重なる部分（冗語、重複、演出の抑制）は本スキルの記述を
...
[`tech-writing`](../tech-writing/SKILL.md#mandatory-textlint-verification-after-drafting)
...
[`../tech-writing/textlint/.textlintrc.json`](../tech-writing/textlint/.textlintrc.json) は、

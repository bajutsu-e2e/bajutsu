...
model: sonnet
description: Apply Bajutsu's language-independent prose rules when writing or revising roadmap items or documentation. Use it with the matching English or Japanese writing skill.
---
...
- **An umbrella above two language layers.** The *language-agnostic principles* below hold for both
  ...
  [`english-document-writing`](../../../.apm/skills/english-document-writing/SKILL.md) (serial comma, *that* / *which*,
  dashes, numbers, and the rest of the English mechanics); for **Japanese**,
  [`japanese-document-writing`](../../../.apm/skills/japanese-document-writing/SKILL.md). Each language layer holds only the
...
[`english-document-writing`](../../../.apm/skills/english-document-writing/SKILL.md) for English,
[`japanese-document-writing`](../../../.apm/skills/japanese-document-writing/SKILL.md) for Japanese.
...
The config and runtime live in [`tools/textlint/`](../../../tools/textlint/). It needs node and
npm (the same prerequisite as this repo's other JS checks). Run it from the repository root, passing
the Markdown file(s) you wrote or edited.

```bash
TEXTLINT_DIR=tools/textlint
...
# scripts (both are supply-chain defenses; see tools/textlint/README.md for why)
npm --prefix "$TEXTLINT_DIR" ci --ignore-scripts
# Verify (pass as many target files as you like)
npx --prefix "$TEXTLINT_DIR" textlint \
...
Edit [`.textlintrc.json`](../../../tools/textlint/.textlintrc.json) to change what's enforced. It
...
section of [`tools/textlint/README.md`](../../../tools/textlint/README.md); the same file covers
how to add or retire a rule. Change the config only for structural reasons — adopting or retiring
a rule, or stopping a rule from double-reporting what another already covers. Do not loosen a rule or raise a threshold to
...
- [`english-document-writing`](../../../.apm/skills/english-document-writing/SKILL.md) — the English layer beneath
  this norm.
- [`japanese-document-writing`](../../../.apm/skills/japanese-document-writing/SKILL.md) — the Japanese layer beneath this
  norm.

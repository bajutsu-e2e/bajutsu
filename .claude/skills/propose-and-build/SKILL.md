...
- [`ideation`](../../../.apm/skills/ideation/SKILL.md) — authors a proposal and stops at the roadmap files
  (never touches product code).
- [`implement-be`](../../../.apm/skills/implement-be/SKILL.md) — ships an *already-numbered* item from its id.
...
- **Fall back to the serial path** ([`ideation`](../../../.apm/skills/ideation/SKILL.md) →
  [`implement-be`](../../../.apm/skills/implement-be/SKILL.md)) when the design is genuinely uncertain, wide-
...
- If a later session is invoked for something else entirely on this PR (e.g. via
  [`pr-followup`](../../../.apm/skills/pr-followup/SKILL.md)) and notices the row is still unfilled, filling it in
...
- [`ideation`](../../../.apm/skills/ideation/SKILL.md) — the upstream skill this composes for Phase A (authoring
  only, never implements).
- [`implement-be`](../../../.apm/skills/implement-be/SKILL.md) — the skill this composes for Phase B (steps 3–9); the

...
It sits beneath the language-agnostic [`document-writing`](../document-writing/workflow.md) skill. When you
...
in [`japanese-document-writing`](../japanese-document-writing/workflow.md), the sibling layer beneath the same
umbrella.
...
[`document-writing`](../document-writing/workflow.md#verify-your-work). Then run the mandatory
...
[`document-writing`'s textlint section](../document-writing/workflow.md#mandatory-textlint-verification-after-drafting).
...
- [`document-writing`](../document-writing/workflow.md) — the language-agnostic umbrella above this layer.
- [`japanese-document-writing`](../japanese-document-writing/workflow.md) — the Japanese sibling layer.

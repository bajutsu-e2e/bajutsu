...
- **An umbrella above two language layers.** The *language-agnostic principles* below hold for both
  ...
  [`english-document-writing`](../english-document-writing/workflow.md) (serial comma, *that* / *which*,
  dashes, numbers, and the rest of the English mechanics); for **Japanese**,
  [`japanese-document-writing`](../japanese-document-writing/workflow.md). Each language layer holds only the
...
[`english-document-writing`](../english-document-writing/workflow.md) for English,
[`japanese-document-writing`](../japanese-document-writing/workflow.md) for Japanese.

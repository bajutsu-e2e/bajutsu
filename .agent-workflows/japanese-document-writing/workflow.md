...
本スキルは、言語に依存しない執筆規範 [`document-writing`](../document-writing/workflow.md)
の下位に位置する日本語レイヤーである。同じ傘の下には、対になる英語レイヤー
[`english-document-writing`](../english-document-writing/workflow.md) がある。日本語の散文を書くときは
...
言語に依存しない原則は上位規範
[`document-writing`](../document-writing/workflow.md#paragraph-structure-both-languages)
...
[`document-writing`](../document-writing/workflow.md#minimize-anaphora-both-languages)

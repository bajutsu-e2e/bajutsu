...
**cannot see**, through the SpringBoard query, while `interrupts` handles a screen the tree **can**
see with a machine-checkable condition. When to reach for which:

...
- [recording.md](../../recording.md) — the `record` loop and the `Agent` abstraction
- [scenarios.md](../../scenarios.md), `bajutsu/scenario.py` — the scenario schema and load/dump path

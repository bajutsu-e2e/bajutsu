[English](BE-XXXX-scenario-provenance.md) · **日本語**

# BE-XXXX — シナリオの来歴（`from:` — ステップ ↔ 自然言語の対応）
...
- [recording.md](../../ja/recording.md) — `record` ループと `Agent` 抽象
- [scenarios.md](../../ja/scenarios.md)、`bajutsu/scenario.py` — シナリオスキーマと load/dump 経路

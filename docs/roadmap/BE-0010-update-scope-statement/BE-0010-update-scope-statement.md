...
- **[architecture status](../../architecture.md)** — register the new backend in the implementation-status table.
- **docs navigation** — both [`docs/README.md`](../../README.md) and [`docs/ja/README.md`](../../ja/README.md).

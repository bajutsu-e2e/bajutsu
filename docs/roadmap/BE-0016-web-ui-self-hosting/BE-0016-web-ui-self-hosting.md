...
- **Tier A — today-ready.** What runs *today* with the existing stdlib `bajutsu serve`
  (`bajutsu/serve.py`), already shipped as [BE-0011](../BE-0011-local-web-ui-serve/BE-0011-local-web-ui-serve.md),
...
[BE-0011](../BE-0011-local-web-ui-serve/BE-0011-local-web-ui-serve.md). This tier makes it safely
...
`bajutsu/serve.py`, [cli.md](../../cli.md#serve), [ci.md](../../ci.md),

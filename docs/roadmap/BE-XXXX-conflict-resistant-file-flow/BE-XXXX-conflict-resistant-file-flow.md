...
[ai-development.md](../../ai-development.md)), and pull requests conflict far more often than the
...
|---|---|---|
| Shared append-only ledger | `docs/roadmap/README.md` (12), `README-ja.md` (11) | Every roadmap PR appends a row to the **same** topic table; independent items collide textually |
...
- [ai-development.md](../../ai-development.md) — parallel-work guide (worktrees, rebase, lanes)

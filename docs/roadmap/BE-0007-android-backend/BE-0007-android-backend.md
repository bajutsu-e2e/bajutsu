...
fail-ambiguity-fast* pattern (see [drivers](../../drivers.md)) almost unchanged. Building it
...
whatever matched first" (see [drivers](../../drivers.md)). Validating it proves the iOS-specific

...
targets:
  showcase-swiftui:             # ← selected by --target showcase-swiftui
    ...
    systemAlertHandling:  { instruction: Allow }     # app default for the alert guard (below); --system-alert-handling overrides per run

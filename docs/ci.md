...
jobs:
  e2e:
    ...
    steps:
      ...
      # --- run bajutsu ---
      # bajutsu.config.yaml's `targets.myapp` must set
      #   appPath: dd/Build/Products/Debug-iphonesimulator/MyApp.app
      # the action's `--erase` wipes the install above, and appPath is what puts the app back.

[English](../../roadmap/BE-0004-m4-self-healing-triage.md) · **日本語**

# BE-0004 — 自己修復トリアージ（M4）

* 提案: [BE-0004](BE-0004-m4-self-healing-triage.md)
* 状態: **実装済み**
...
[DESIGN §3.1 / §12](../../../DESIGN.md)、[reporting.md](../reporting.md)、`bajutsu/triage.py`、[自己修復トリアージ（M4）](README.md#自己修復トリアージm4)

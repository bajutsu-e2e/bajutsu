...
| 16 | [vision](vision.md) | **将来構想** — 成長の 3 軸（reach / scale / authoring）と、すべてが守る制約。具体的な計画は[ロードマップ](../roadmap/README-ja.md)の各項目になりました |
| 17 | [ai-development](ai-development.md) | AI エージェントと人間の並行開発の運用規約（ゲート / ブランチ / pre-push フック / worktree）—— [`CLAUDE.md`](../../CLAUDE.md) の詳細版 |

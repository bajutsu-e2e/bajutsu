...
（[`demos/features/app/scenarios/permission.yaml`](../../demos/features/app/scenarios/permission.yaml) 実物）
...
（[`demos/features/app/scenarios/gestures.yaml`](../../demos/features/app/scenarios/gestures.yaml) 実物）

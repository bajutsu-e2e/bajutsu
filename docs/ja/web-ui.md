...
ヘッダには 7 つのトップレベルタブがあります。**Record**、**Replay**、**Crawl**、**Author**、
**Stats**、**Usage**、**Coverage** です。その右に **Open config**（config を bind すると隣にその名前が出ます）と、
...
Stats、Usage、Coverage）は AI の設定なしで動きます。

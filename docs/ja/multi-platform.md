...
| **段階 1 — Web** | Playwright。**既存の Linux ゲートで動き、Mac もエミュレータも不要**。能力モデルの豊かな端を行使。最初に推奨 | 計画 — [BE-0041](../../roadmaps/proposals/BE-0041-web-playwright-backend/BE-0041-web-playwright-backend-ja.md) |
...
| **横断** | マルチプラットフォーム化は戦略的なスコープ変更（DESIGN / README / docs） | 計画 — [BE-0010](../../roadmaps/proposals/BE-0010-update-scope-statement/BE-0010-update-scope-statement-ja.md) |

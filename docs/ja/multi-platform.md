...
| **共有抽象** | `Environment` Protocol の抽出、iOS 固有の漏れの点検、セレクタ / config / 決定性の設計 | 実装中（[BE-0009](../../roadmaps/implemented/BE-0009-cross-platform-abstractions/BE-0009-cross-platform-abstractions-ja.md)） |

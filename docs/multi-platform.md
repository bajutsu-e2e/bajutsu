...
| **Shared abstractions** | Extract an `Environment` Protocol; audit for leaked iOS-isms; the selector / config / determinism design | Implemented — [BE-0009](../roadmaps/implemented/BE-0009-cross-platform-abstractions/BE-0009-cross-platform-abstractions.md) |
...
| **Phase 2 — Android** | adb + UI Automator; the coordinate-driven twin of idb | In progress — [BE-0007](../roadmaps/in-progress/BE-0007-android-backend/BE-0007-android-backend.md) |

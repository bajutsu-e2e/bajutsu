...
| **Shared abstractions** | Extract an `Environment` Protocol; audit for leaked iOS-isms; the selector / config / determinism design | In progress — [BE-0009](../roadmaps/in-progress/BE-0009-cross-platform-abstractions/BE-0009-cross-platform-abstractions.md) |

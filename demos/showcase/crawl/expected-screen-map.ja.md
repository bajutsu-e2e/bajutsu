...
> `crawl`（[BE-0038](../../../roadmaps/in-progress/BE-0038-autonomous-crawl-exploration/BE-0038-autonomous-crawl-exploration-ja.md)）
...
識別子の整列集合をハッシュ化したもの。
[BE-0038](../../../roadmaps/in-progress/BE-0038-autonomous-crawl-exploration/BE-0038-autonomous-crawl-exploration-ja.md)）
は実行をまたいで安定します。

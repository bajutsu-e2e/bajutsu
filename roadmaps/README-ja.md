...
| [BE-0245](BE-0245-adb-resident-uiautomator-server/BE-0245-adb-resident-uiautomator-server-ja.md) | adb の読み取り向け常駐 UI Automator サーバ | 実装中 |
<!-- /GENERATED:in-progress-platform -->
...
| ID | 項目 | 状態 |
|---|---|---|
| [BE-0268](BE-0268-composable-upload-artifacts/BE-0268-composable-upload-artifacts-ja.md) | config・シナリオ・アプリバイナリを独立した content-addressed な成果物として個別にアップロードし run ごとに合成する | 提案 |
<!-- /GENERATED:proposals-config-sourcing -->
...
| ID | 項目 | 状態 |
|---|---|---|
| [BE-0266](BE-0266-contributor-workflow-tutorial/BE-0266-contributor-workflow-tutorial-ja.md) | コントリビューションワークフローチュートリアル: ideation・implement-be・propose-and-build を実際に使うガイド | 提案 |
<!-- /GENERATED:proposals-developer-experience -->
...
| [BE-0254](BE-0254-coordinate-tree-driver-base/BE-0254-coordinate-tree-driver-base-ja.md) | idb と adb 向けに共有の CoordinateTreeDriver 基底クラスを抽出する | 提案 |
| [BE-0255](BE-0255-codegen-shared-helper-dedup/BE-0255-codegen-shared-helper-dedup-ja.md) | codegen の識別子と正規表現のヘルパーを codegen_common に集約する | 提案 |
...
| [BE-0258](BE-0258-serve-step-artifact-seam/BE-0258-serve-step-artifact-seam-ja.md) | serve のステップアーティファクトの読み取りを ArtifactStore seam 経由に統一 | 提案 |
| [BE-0259](BE-0259-assert-query-snapshot-reuse/BE-0259-assert-query-snapshot-reuse-ja.md) | assert と extract のステップで、確定した query のスナップショットを使い回す | 提案 |
| [BE-0261](BE-0261-serve-author-yaml-roundtrip/BE-0261-serve-author-yaml-roundtrip-ja.md) | Author の YAML 編集を serializer で往復させる | 提案 |

...
| ID | 項目 | 状態 |
|---|---|---|
| [BE-0231](BE-0231-smoke-idb-first-wait-settling/BE-0231-smoke-idb-first-wait-settling-ja.md) | E2E の最初の待機を Simulator の settling flake に対して硬化する | 実装中 |
<!-- /GENERATED:in-progress-platform -->
...
| [BE-0269](BE-0269-ios-alert-guard-early-wait-intervention/BE-0269-ios-alert-guard-early-wait-intervention-ja.md) | wait ステップ中のシステムアラートガードの介入を早める | 提案 |
<!-- /GENERATED:proposals-platform -->
...
| ID | 項目 | 状態 |
|---|---|---|
| [BE-0270](BE-0270-android-adb-driver-conformance/BE-0270-android-adb-driver-conformance-ja.md) | adb backend の実機 driver conformance | 提案 |
<!-- /GENERATED:proposals-driver-architecture -->
...
| [BE-0267](BE-0267-serve-author-actuator-selection/BE-0267-serve-author-actuator-selection-ja.md) | serve の capture・enrich でコスト順のアクチュエータ選択を再利用する | 提案 |
...
| ID | 項目 | 状態 |
|---|---|---|
| [BE-0275](BE-0275-serve-projects-management-page/BE-0275-serve-projects-management-page-ja.md) | serve にプロジェクト管理ページを設ける（モーダルではなくトップレベルのビュー） | 提案 |
<!-- /GENERATED:proposals-serve-cli-features -->

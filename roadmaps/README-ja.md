...
| [BE-0273](BE-0273-serve-replay-scenario-viewer/BE-0273-serve-replay-scenario-viewer-ja.md) | Replay タブからシナリオの内容を確認する（生 YAML と構造化ステップ） | 提案 |
<!-- /GENERATED:proposals-authoring -->
...
| [BE-0277](BE-0277-docker-build-commit-badge/BE-0277-docker-build-commit-badge-ja.md) | セルフホスト用 Docker イメージにコミットハッシュを埋め込み、バージョンバッジに表示する | 提案 |
<!-- /GENERATED:proposals-hosting -->

...
| ID | 項目 | 状態 |
|---|---|---|
| [BE-0248](BE-0248-serve-state-decomposition-continued/BE-0248-serve-state-decomposition-continued-ja.md) | ServeState の分解を継続し、認証系とプロバイダー設定系のマネージャに分離する | 提案 |
| [BE-0247](BE-0247-serve-frontend-es-modules/BE-0247-serve-frontend-es-modules-ja.md) | serve フロントエンドを ES モジュールへ移行する | 提案 |
| [BE-0250](BE-0250-assertions-package-eval-context/BE-0250-assertions-package-eval-context-ja.md) | assertions のパッケージ分割と評価コンテキストの EvalContext への統合 | 提案 |
| [BE-0252](BE-0252-config-package-split/BE-0252-config-package-split-ja.md) | config をパッケージに分割し、Effective をサブレコードにまとめる | 提案 |
| [BE-0253](BE-0253-serve-route-registry-unification/BE-0253-serve-route-registry-unification-ja.md) | serve の二重バックエンドのルートテーブルを宣言的レジストリに統一する | 提案 |
| [BE-0256](BE-0256-platform-lifecycle-package-split/BE-0256-platform-lifecycle-package-split-ja.md) | platform_lifecycle をパッケージへ分割し、デバイス解決を Environment という seam に通す | 提案 |
<!-- /GENERATED:proposals-quality-debt -->

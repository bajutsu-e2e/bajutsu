...
| ID | 項目 | 状態 |
|---|---|---|
| [BE-0191](BE-0191-pluggable-theme-system-serve-ui/BE-0191-pluggable-theme-system-serve-ui-ja.md) | serve Web UI のプラガブルなテーマシステム（ビジュアルトークンと差し替え可能なトランジション） | 実装中 |
<!-- /GENERATED:in-progress-authoring -->
...
| [BE-0208](BE-0208-android-emulator-e2e-ci/BE-0208-android-emulator-e2e-ci-ja.md) | Android の実機 e2e を CI に配線する（KVM 経由のエミュレータ） | 提案 |
| [BE-0210](BE-0210-android-actuation-fidelity/BE-0210-android-actuation-fidelity-ja.md) | Android 実機アクチュエーションの忠実度 | 提案 |
| [BE-0211](BE-0211-android-device-control/BE-0211-android-device-control-ja.md) | Android のデバイス制御（setLocation、クリップボード） | 提案 |
| [BE-0212](BE-0212-granular-device-control-capabilities/BE-0212-granular-device-control-capabilities-ja.md) | 粗い deviceControl 能力を操作単位のトークンに分割する | 提案 |
<!-- /GENERATED:proposals-platform -->
...
| [BE-0215](BE-0215-claude-code-oauth-token-credential/BE-0215-claude-code-oauth-token-credential-ja.md) | claude-code プロバイダに CLAUDE_CODE_OAUTH_TOKEN による明示的な資格情報を追加する | 提案 |
<!-- /GENERATED:proposals-ai-provider -->
...
| [BE-0216](BE-0216-propose-and-build-parallel-skill/BE-0216-propose-and-build-parallel-skill-ja.md) | propose-and-build: BE 提案と実装を並行して書き、スタックしてつなぐ | 提案 |
<!-- /GENERATED:proposals-dev-infra -->

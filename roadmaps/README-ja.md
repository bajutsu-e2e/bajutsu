...
| [BE-0279](BE-0279-crossbackend-e2e-required-gate/BE-0279-crossbackend-e2e-required-gate-ja.md) | E2E の必須チェックを全 backend に揃える | 実装済み |
<!-- /GENERATED:implemented-platform -->
...
| [BE-0284](BE-0284-docs-single-source-of-truth/BE-0284-docs-single-source-of-truth-ja.md) | 重複するドキュメント規範を1つの基準ファイルへ集約する | 実装済み |
| [BE-0286](BE-0286-glossary-link-requirement/BE-0286-glossary-link-requirement-ja.md) | 用語集の用語を初出時にリンクする | 実装済み |
<!-- /GENERATED:implemented-developer-experience -->
...
| [BE-0257](BE-0257-layer-package-topology/BE-0257-layer-package-topology-ja.md) | 強制されているアーキテクチャレイヤをディレクトリとしてパッケージ化する | 実装済み |

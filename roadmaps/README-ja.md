...
| [BE-0191](BE-0191-pluggable-theme-system-serve-ui/BE-0191-pluggable-theme-system-serve-ui-ja.md) | serve Web UI のプラガブルなテーマシステム（ビジュアルトークンと差し替え可能なトランジション） | 提案 |
| [BE-0192](BE-0192-record-vision-on-demand/BE-0192-record-vision-on-demand-ja.md) | record のスクリーンショットを必要なときだけ送る（vision-on-demand） | 提案 |
| [BE-0193](BE-0193-record-screenshot-downscale/BE-0193-record-screenshot-downscale-ja.md) | record のスクリーンショットを送信前に適正サイズへ決定的に縮小する | 提案 |
| [BE-0194](BE-0194-record-turn-payload-diet/BE-0194-record-turn-payload-diet-ja.md) | record の 1 ターンのペイロードを痩せさせる（要素ツリーの圧縮、トークン予算ノブ、種別ごとの使用量） | 提案 |
<!-- /GENERATED:proposals-authoring -->
...
| ID | 項目 | 状態 |
|---|---|---|
| [BE-0183](BE-0183-per-provider-serve-settings/BE-0183-per-provider-serve-settings-ja.md) | serve の Web UI で AI プロバイダーごとの設定を持てるようにする | 提案 |
| [BE-0184](BE-0184-persist-serve-ai-provider-settings/BE-0184-persist-serve-ai-provider-settings-ja.md) | serve の AI プロバイダー設定を再起動をまたいで永続化する | 提案 |
<!-- /GENERATED:proposals-ai-provider -->
...
| ID | 項目 | 状態 |
|---|---|---|
| [BE-0195](BE-0195-ai-usage-cost-dashboard/BE-0195-ai-usage-cost-dashboard-ja.md) | AI のトークン使用量とコストを serve の Web UI で可視化する | 提案 |
| [BE-0196](BE-0196-ai-usage-cost-ledger/BE-0196-ai-usage-cost-ledger-ja.md) | AI のトークン使用量とコストを属性付きの永続的な台帳として記録する | 提案 |
<!-- /GENERATED:proposals-ai-usage -->
...
| [BE-0190](BE-0190-org-scoped-crawl-history/BE-0190-org-scoped-crawl-history-ja.md) | サーバーバックエンドでの org スコープ付き crawl 履歴 | 提案 |
<!-- /GENERATED:proposals-hosting -->

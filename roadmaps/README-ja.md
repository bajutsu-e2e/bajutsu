...
| ID | 項目 | 状態 |
|---|---|---|
| [BE-0178](BE-0178-record-multi-action-turn/BE-0178-record-multi-action-turn-ja.md) | record の 1 ターンで複数アクションをまとめて実行する | 提案 |
| [BE-0179](BE-0179-record-human-handoff/BE-0179-record-human-handoff-ja.md) | record 中の human-in-the-loop ハンドオフ（一時停止・引き渡し・再開） | 提案 |
...
| ID | 項目 | 状態 | 由来 |
|---|---|---|---|
| [BE-0189](BE-0189-serve-ui-dogfood-ci-gate/BE-0189-serve-ui-dogfood-ci-gate-ja.md) | serve Web UI のドッグフードを CI でゲートする | 提案 | Dogfooding |
<!-- /GENERATED:proposals-dogfood-web-ui -->
...
| [BE-0188](BE-0188-configurable-ai-output-language/BE-0188-configurable-ai-output-language-ja.md) | AI 出力言語を record と crawl で設定可能にする | 提案 |
<!-- /GENERATED:proposals-ai-provider -->
...
| ID | 項目 | 状態 |
|---|---|---|
| [BE-0187](BE-0187-serve-config-view/BE-0187-serve-config-view-ja.md) | serve の Web UI で読み込み中の config を確認する（生 YAML、構造化ツリー、Git 由来） | 提案 |
<!-- /GENERATED:proposals-config-sourcing -->
...
| ID | 項目 | 状態 |
|---|---|---|
| [BE-0181](BE-0181-crawl-continuation/BE-0181-crawl-continuation-ja.md) | クロールを途中から再開できるようにする（Web UI 対応、フロンティア全体の再開） | 提案 |
<!-- /GENERATED:proposals-crawl -->

...
| ID | 項目 | 状態 |
|---|---|---|
| [BE-0176](BE-0176-claude-code-ai-backend/BE-0176-claude-code-ai-backend-ja.md) | Claude Code を AiBackend アダプタとして復活させる（ファイル経由の vision 付き） | 提案 |
<!-- /GENERATED:proposals-ai-provider -->
...
| [BE-0173](BE-0173-slim-web-worker-image/BE-0173-slim-web-worker-image-ja.md) | Slim Linux web-worker container image | 提案 |
<!-- /GENERATED:proposals-hosting -->
...
| ID | 項目 | 状態 |
|---|---|---|
| [BE-0174](BE-0174-scenario-ref-path-containment/BE-0174-scenario-ref-path-containment-ja.md) | シナリオの component／data 参照をスイートのルート内に封じ込める | 提案 |
<!-- /GENERATED:proposals-security -->
...
| ID | 項目 | 状態 |
|---|---|---|
| [BE-0177](BE-0177-run-behavior-target-config/BE-0177-run-behavior-target-config-ja.md) | run のテスト動作設定にターゲット config の既定値を持たせる | 提案 |
<!-- /GENERATED:proposals-config-sourcing -->

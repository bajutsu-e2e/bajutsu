...
| 実装 PR | [#1093](https://github.com/bajutsu-e2e/bajutsu/pull/1093)、[#1100](https://github.com/bajutsu-e2e/bajutsu/pull/1100)、[#1106](https://github.com/bajutsu-e2e/bajutsu/pull/1106)、[#PRNUM](https://github.com/bajutsu-e2e/bajutsu/pull/PRNUM) |
| トピック | コードベース品質・技術的負債 |
...
- ユニット 4（種別タプルの導出）— `scenario/models/_base.py` で手動保守していた `_ASSERTION_KINDS` タプルを、
  ...
  PR は [#PRNUM](https://github.com/bajutsu-e2e/bajutsu/pull/PRNUM) です。

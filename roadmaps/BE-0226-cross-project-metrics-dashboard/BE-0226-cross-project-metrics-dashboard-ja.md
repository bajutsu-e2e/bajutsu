...
| 実装 PR | [#936](https://github.com/bajutsu-e2e/bajutsu/pull/936), [#940](https://github.com/bajutsu-e2e/bajutsu/pull/940), _pending_ |
...
- _pending_ — Unit 3。serve の **Metrics** タブが比較モデルをクライアント側で描画します。ソート可能な

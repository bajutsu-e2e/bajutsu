...
| 実装 PR | [#936](https://github.com/bajutsu-e2e/bajutsu/pull/936), [#940](https://github.com/bajutsu-e2e/bajutsu/pull/940) |
...
- [ ] 3. UI：ソート可能な比較表とプロジェクトごとのトレンドスパークライン。BE-0102 の単一 config ダッシュボードへディープリンクする。

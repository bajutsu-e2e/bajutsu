...
| Implementing PR | [#936](https://github.com/bajutsu-e2e/bajutsu/pull/936), [#940](https://github.com/bajutsu-e2e/bajutsu/pull/940), _pending_ |
...
- _pending_ — Unit 3. A **Metrics** tab in serve renders the comparison model client-side: a

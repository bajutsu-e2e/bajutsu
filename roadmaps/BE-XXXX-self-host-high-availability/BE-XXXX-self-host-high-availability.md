**English** · [日本語](BE-XXXX-self-host-high-availability-ja.md)

# BE-XXXX — Self-hosted high availability and single-point-of-failure hardening

<!-- BE-METADATA -->
| Field | Value |
|---|---|
| Proposal | [BE-XXXX](BE-XXXX-self-host-high-availability.md) |

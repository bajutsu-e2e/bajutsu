**English** · [日本語](BE-XXXX-serve-active-org-selection-ja.md)

# BE-XXXX — Choose the active org in serve when a login belongs to several

<!-- BE-METADATA -->
| Field | Value |
|---|---|
| Proposal | [BE-XXXX](BE-XXXX-serve-active-org-selection.md) |

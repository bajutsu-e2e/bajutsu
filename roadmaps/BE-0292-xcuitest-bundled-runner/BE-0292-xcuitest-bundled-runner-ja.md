...
| 実装 PR | [#1221](https://github.com/bajutsu-e2e/bajutsu/pull/1221)、[#NNNN](https://github.com/bajutsu-e2e/bajutsu/pull/NNNN) |
| トピック | プラットフォーム対応 |
...
- [#NNNN](https://github.com/bajutsu-e2e/bajutsu/pull/NNNN) — 見送っていた 2 つの半分を完了しました。

[English](BE-0380-fix-issue-skill.md) · **日本語**

# BE-0380 — fix-issueスキルが、ロードマップ項目なしに軽微なGitHub Issueを実装まで運ぶ
...
| 実装 PR | [#1679](https://github.com/bajutsu-e2e/bajutsu/pull/1679) |

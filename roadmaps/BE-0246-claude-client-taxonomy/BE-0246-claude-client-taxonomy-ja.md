...
| 実装 PR | [#1012](https://github.com/bajutsu-e2e/bajutsu/pull/1012), [#1030](https://github.com/bajutsu-e2e/bajutsu/pull/1030), [#_pending_](https://github.com/bajutsu-e2e/bajutsu/pull/_pending_) |
| トピック | コードベース品質・技術的負債 |
<!-- /BE-METADATA -->
...
- [#1034](https://github.com/bajutsu-e2e/bajutsu/pull/1034) — Unit 3: `bajutsu/claude_backed_agent.py` を新設し、`ClaudeBackedAgent` 基底
  ...
  回帰の網です。
- [#_pending_](https://github.com/bajutsu-e2e/bajutsu/pull/_pending_) — Unit 5:

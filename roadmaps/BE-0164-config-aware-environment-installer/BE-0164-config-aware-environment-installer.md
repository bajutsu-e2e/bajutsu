**English** · [日本語](BE-0164-config-aware-environment-installer-ja.md)

# BE-0164 — Config-aware environment installer
...
| Implementing PR | [#679](https://github.com/bajutsu-e2e/bajutsu/pull/679) |

[English](BE-XXXX-repl-tui-and-target-selectors.md) · **日本語**

# BE-XXXX — `repl`のncurses風画面と、`tap`/`type`の`label`・`index`・座標ターゲット

<!-- BE-METADATA -->
| 項目 | 値 |
|---|---|
| 提案 | [BE-XXXX](BE-XXXX-repl-tui-and-target-selectors-ja.md) |

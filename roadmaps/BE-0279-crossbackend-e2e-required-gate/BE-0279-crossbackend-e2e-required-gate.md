...
- [x] `E2E (android)` aggregator in `android-e2e.yml` — `needs: [smoke, conformance]`, `if: always()`,
...
- [x] `E2E (web)` aggregator in `web-e2e.yml` — `needs: [smoke, dogfood, conformance]`, same trigger

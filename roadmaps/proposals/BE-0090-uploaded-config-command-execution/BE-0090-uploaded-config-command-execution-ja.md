...
- [BE-0073 — config・シナリオ・アプリバイナリのバンドルをアップロードしてアクティブな config としてバインドする](../../implemented/BE-0073-serve-zip-bundle-upload/BE-0073-serve-zip-bundle-upload-ja.md) — アップロード経路。`build` がアップロードに対して拒否され、`launchServer` は拒否されない箇所。

...
(the `server` backend, [BE-0015](../../in-progress/BE-0015-web-ui-public-hosting/BE-0015-web-ui-public-hosting.md)):
...
- **Trigger on non-loopback exposure instead of the backend.** Disable the file browser whenever
  ...
  ([BE-0016](../../in-progress/BE-0016-web-ui-self-hosting/BE-0016-web-ui-self-hosting.md) Tier A) is

**English** · [日本語](BE-XXXX-regenerable-reports-ja.md)

# BE-XXXX — Regenerable reports (render from stored run data)

* Proposal: [BE-XXXX](BE-XXXX-regenerable-reports.md)
...
3. **A hosted or shared `serve` shows stale reports.** When `serve`
   ([BE-0011](../../implemented/BE-0011-local-web-ui-serve/BE-0011-local-web-ui-serve.md)) is

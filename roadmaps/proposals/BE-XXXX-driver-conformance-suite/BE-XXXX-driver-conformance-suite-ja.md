[English](BE-XXXX-driver-conformance-suite.md) · **日本語**

# BE-XXXX — backend 非依存の挙動を検査する driver conformance suite

<!-- BE-METADATA -->
| 項目 | 値 |
|---|---|
| 提案 | [BE-XXXX](BE-XXXX-driver-conformance-suite-ja.md) |
...
- [ ] FakeDriver と Playwright を高速な Linux ゲート（`make check`）で走らせる

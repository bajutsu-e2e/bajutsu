**English** · [日本語](BE-XXXX-capability-preflight-check-ja.md)

# BE-XXXX — Preflight capability check before a run

<!-- BE-METADATA -->
| Field | Value |
|---|---|
| Proposal | [BE-XXXX](BE-XXXX-capability-preflight-check.md) |

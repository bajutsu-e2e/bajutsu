...
- [BE-0117 — Cover the rest of the CLI command layer, then ratchet the coverage floor](../../implemented/BE-0117-coverage-floor-ratchet/BE-0117-coverage-floor-ratchet.md)

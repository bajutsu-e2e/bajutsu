[English](BE-XXXX-device-state-timezone-clipboard-shake.md) · **日本語**

# BE-XXXX — デバイス状態プリミティブ: タイムゾーン・クリップボード・シェイク

* 提案: [BE-XXXX](BE-XXXX-device-state-timezone-clipboard-shake-ja.md)
* 状態: **提案**

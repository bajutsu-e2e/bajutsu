**English** · [日本語](BE-XXXX-per-platform-effective-config-ja.md)

# BE-XXXX — Split Effective into per-platform configs

<!-- BE-METADATA -->
| Field | Value |
|---|---|
| Proposal | [BE-XXXX](BE-XXXX-per-platform-effective-config.md) |

...
[BE-0041](../../implemented/BE-0041-web-playwright-backend/BE-0041-web-playwright-backend-ja.md) で着地した Web backend は、
...
列挙したエンジンごとに一度ずつ実行します。これは [BE-0054](../../implemented/BE-0054-web-backend-completion/BE-0054-web-backend-completion-ja.md)
...
* **[BE-0041](../../implemented/BE-0041-web-playwright-backend/BE-0041-web-playwright-backend-ja.md) の上に積む**（web backend）。
  ファンアウトには **[BE-0054](../../implemented/BE-0054-web-backend-completion/BE-0054-web-backend-completion-ja.md) の並列レーンを
...
* [CLAUDE.md](../../../CLAUDE.md)、[DESIGN.md](../../../DESIGN.md) — 本提案が守る prime directive。AI は判定しない
  ...
  内容ではない）。
* [BE-0041 — Web (Playwright) backend](../../implemented/BE-0041-web-playwright-backend/BE-0041-web-playwright-backend-ja.md) — 本アイテムが
  拡張する backend と、その「クロスブラウザ」という seam の約束。
* [BE-0054 — Web backend completion](../../implemented/BE-0054-web-backend-completion/BE-0054-web-backend-completion-ja.md) — このファンアウトが

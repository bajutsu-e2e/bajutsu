...
`// TODO` フォールバック自体は残ります。本当に未対応の構文は引き続きここで捕捉します（[BE-0026](../../proposals/BE-0026-shrink-unsupported-syntax/BE-0026-shrink-unsupported-syntax-ja.md) を参照）。本提案はその集合から座標 swipe を取り除くだけです。

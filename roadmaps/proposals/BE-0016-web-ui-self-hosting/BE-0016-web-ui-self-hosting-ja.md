...
- **段階 A — 今日すぐ使える。** 既存の stdlib `bajutsu serve`（`bajutsu/serve.py`、すでに
  [BE-0011](../../implemented/BE-0011-local-web-ui-serve/BE-0011-local-web-ui-serve-ja.md) として実装済み）に、
...
[BE-0011](../../implemented/BE-0011-local-web-ui-serve/BE-0011-local-web-ui-serve-ja.md) として実装済みです。この
...
`bajutsu/serve.py`、[cli.md](../../../docs/ja/cli.md#serve)、[ci.md](../../../docs/ja/ci.md)、

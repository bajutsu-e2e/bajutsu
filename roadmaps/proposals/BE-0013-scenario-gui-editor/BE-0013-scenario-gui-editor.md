...
**Dependencies / related items:** [BE-0011](../../implemented/BE-0011-local-web-ui-serve/BE-0011-local-web-ui-serve.md) (the `serve` host, `ScenarioScope`, screenshot plumbing this extends), [BE-0012](../../in-progress/BE-0012-action-capture-record/BE-0012-action-capture-record.md) (**shares the point → element picker + doctor score — one resolver, two sources**: the editor reads captured artifacts, capture reads a live driver), [BE-0014](../BE-0014-record-demarcation/BE-0014-record-demarcation.md) (the role demarcation across the authoring surfaces).

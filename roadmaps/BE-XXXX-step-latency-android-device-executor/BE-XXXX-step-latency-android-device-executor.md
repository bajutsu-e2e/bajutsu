**English** · [日本語](BE-XXXX-step-latency-android-device-executor-ja.md)

# BE-XXXX — Android on-device step executor inside the instrumentation server

<!-- BE-METADATA -->
| Field | Value |
|---|---|
| Proposal | [BE-XXXX](BE-XXXX-step-latency-android-device-executor.md) |

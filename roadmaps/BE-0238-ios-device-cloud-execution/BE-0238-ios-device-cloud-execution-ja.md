...
- live の経路 スライス B（[#PENDING](https://github.com/bajutsu-e2e/bajutsu/pull/PENDING)）：live の経路の入力とジェスチャを、Appium

[English](BE-XXXX-hosted-scenario-local-read.md) · **日本語**

# BE-XXXX — ホスト提供シナリオを object storage ではなく束縛済み config のローカルキャッシュツリーから読む

<!-- BE-METADATA -->
| 項目 | 値 |
|---|---|
| 提案 | [BE-XXXX](BE-XXXX-hosted-scenario-local-read-ja.md) |

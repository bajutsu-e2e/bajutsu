...
| [BE-0090](proposals/BE-0090-uploaded-config-command-execution/BE-0090-uploaded-config-command-execution.md) | Govern command execution from uploaded bundle configs | Proposal |
<!-- /GENERATED:proposals-hosting -->

...
| 実装 PR | [#703](https://github.com/bajutsu-e2e/bajutsu/pull/703) |
...
- [#703](https://github.com/bajutsu-e2e/bajutsu/pull/703) — BE-0147 を出荷しました。`triage --json` が機械可読の結果を run ディレクトリへ書き出し、

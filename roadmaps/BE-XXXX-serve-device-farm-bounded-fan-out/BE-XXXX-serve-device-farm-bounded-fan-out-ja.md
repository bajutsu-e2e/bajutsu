[English](BE-XXXX-serve-device-farm-bounded-fan-out.md) · **日本語**

# BE-XXXX — serve から Device Farm へ投入する、デバイス数を制限したシナリオ単位の分割実行

<!-- BE-METADATA -->
| 項目 | 値 |
|---|---|
| 提案 | [BE-XXXX](BE-XXXX-serve-device-farm-bounded-fan-out-ja.md) |

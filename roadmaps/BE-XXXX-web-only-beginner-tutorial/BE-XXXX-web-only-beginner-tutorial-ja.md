[English](BE-XXXX-web-only-beginner-tutorial.md) · **日本語**

# BE-XXXX — Web 版のみで完結する初学者向けチュートリアル(Xcode・Simulator 不要)

<!-- BE-METADATA -->
| 項目 | 値 |
|---|---|
| 提案 | [BE-XXXX](BE-XXXX-web-only-beginner-tutorial-ja.md) |

...
| 実装 PR | [#692](https://github.com/bajutsu-e2e/bajutsu/pull/692) |
...
- _(後続 PR)_ — Replay ビューの「Generate code」操作。共有のクライアント側ファクトリ `makeCodegen`
  を通じてエンドポイントを再利用し、項目を完了させます（状態を実装済みへ）。

...
（[BE-0068](../BE-0068-regenerable-reports/BE-0068-regenerable-reports-ja.md)）から
...
3. **長時間の自律クロール。** クロール
   （[BE-0038](../BE-0038-autonomous-crawl-exploration/BE-0038-autonomous-crawl-exploration-ja.md)）は
...
- [BE-0068 — 再生成可能なレポート](../BE-0068-regenerable-reports/BE-0068-regenerable-reports-ja.md): 要約が射影する正準な実行モデルとしての `manifest.json`。
...
- [BE-0015](../BE-0015-web-ui-public-hosting/BE-0015-web-ui-public-hosting-ja.md) / [BE-0016](../BE-0016-web-ui-self-hosting/BE-0016-web-ui-self-hosting-ja.md): ホスト型 `serve`。実行に `reportUrl` を与え、もっとも帯域外通知を必要とする面。

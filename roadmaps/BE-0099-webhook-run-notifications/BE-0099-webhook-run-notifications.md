...
([BE-0068](../BE-0068-regenerable-reports/BE-0068-regenerable-reports.md)); Slack is
...
1. **Runs launched from a hosted `serve`.** When `serve` runs on a shared host
   ...
   [BE-0016](../BE-0016-web-ui-self-hosting/BE-0016-web-ui-self-hosting.md)), a run
...
- [BE-0068 — Regenerable reports](../BE-0068-regenerable-reports/BE-0068-regenerable-reports.md) — `manifest.json` as the canonical run model the summary projects from.
...
- [BE-0015](../BE-0015-web-ui-public-hosting/BE-0015-web-ui-public-hosting.md) / [BE-0016](../BE-0016-web-ui-self-hosting/BE-0016-web-ui-self-hosting.md) — hosted `serve`, the surface that gives a run a `reportUrl` and that most needs an out-of-band notification.

[English](BE-XXXX-rename-dismiss-alerts-to-alert-handling.md) · **日本語**

# BE-XXXX — dismissAlerts ガードを、却下も許可も表す alertHandling に改名する

<!-- BE-METADATA -->
| 項目 | 値 |
|---|---|
| 提案 | [BE-XXXX](BE-XXXX-rename-dismiss-alerts-to-alert-handling-ja.md) |

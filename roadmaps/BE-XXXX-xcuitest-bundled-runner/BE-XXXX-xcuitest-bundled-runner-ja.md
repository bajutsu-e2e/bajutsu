...
しない状態か、完全に展開し終わった状態のどちらかしか見ないことです。過去のアップグレードが残した
バージョン鍵付きの古いキャッシュを刈り込む機能は、本項目の対象外とします。各コピーはバージョンで
区切られた有界の成果物であって際限なく増え続けるものではなく、蓄積したサイズが実害になった場合に
キャッシュ削除は別項目として追加できます。

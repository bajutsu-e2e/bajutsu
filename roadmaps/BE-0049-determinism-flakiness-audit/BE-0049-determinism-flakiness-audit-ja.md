...
- 後続。同じ来歴を serve の DB 実行記録にも刻印します（[BE-0015](../BE-0015-web-ui-public-hosting/BE-0015-web-ui-public-hosting-ja.md) で追跡）。

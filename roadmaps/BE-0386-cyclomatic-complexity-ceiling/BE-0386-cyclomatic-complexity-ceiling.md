...
kinds of function recur across the triage, and in both the count comes from the number of cases. We
split neither. The first kind is exhaustive dispatch over a closed schema: the three backends'

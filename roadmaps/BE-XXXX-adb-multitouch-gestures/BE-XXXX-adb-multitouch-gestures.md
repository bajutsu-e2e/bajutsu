**English** · [日本語](BE-XXXX-adb-multitouch-gestures-ja.md)

# BE-XXXX — Multi-touch gestures on the adb driver (pinch / rotate)

<!-- BE-METADATA -->
| Field | Value |
|---|---|
| Proposal | [BE-XXXX](BE-XXXX-adb-multitouch-gestures.md) |

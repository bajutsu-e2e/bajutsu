...
`roadmaps/`, and [BE-0096](../../implemented/BE-0096-docs-roadmap-link-integrity/BE-0096-docs-roadmap-link-integrity.md)
...
GitHub Pages dashboard ([BE-0094](../../implemented/BE-0094-roadmap-status-dashboard/BE-0094-roadmap-status-dashboard.md))
...
10. **Downstream items.** [BE-0154](../../proposals/BE-0154-roadmap-promote-base-sha/BE-0154-roadmap-promote-base-sha.md)
...
- [ ] Flag [BE-0154](../../proposals/BE-0154-roadmap-promote-base-sha/BE-0154-roadmap-promote-base-sha.md)
      for revision or closing once `promote_roadmap_items.py`'s job shrinks to a reindex.

Log:

- PR1 (batch 1): added the transitional dual-layout walk (`roadmap_ids.iter_item_dirs` scans the flat
  root and the legacy folders) across the index / allocate / format / sync / dashboard / lint
  tooling, scaffolded new items flat, and `git mv`'d the Implemented items to the flat root
  (regenerating the index and repairing the cross-links). `promote` still manages the remaining
  foldered items. BE-0159 moved to `In progress`.

## References

- [BE-0078 — Status-driven roadmap folders](../../implemented/BE-0078-roadmap-status-folders/BE-0078-roadmap-status-folders.md)
  — the item this one narrows: keeps its index-bucket idea, retracts its folder-per-status one.
- [BE-0096 — Keep docs links to roadmap items from rotting on promotion](../../implemented/BE-0096-docs-roadmap-link-integrity/BE-0096-docs-roadmap-link-integrity.md)
...
- [BE-0094 — Generated roadmap status dashboard](../../implemented/BE-0094-roadmap-status-dashboard/BE-0094-roadmap-status-dashboard.md)
  — evidence that the four-way grouping already works from `Status` alone, with no folder needed.
- [BE-0149 — Close the roadmap-placeholder format-guardrail gap](../../in-progress/BE-0149-roadmap-placeholder-format-guardrail/BE-0149-roadmap-placeholder-format-guardrail.md)
...
- [BE-0154 — Run roadmap-promote from the base SHA](../../proposals/BE-0154-roadmap-promote-base-sha/BE-0154-roadmap-promote-base-sha.md)

...
Web（Playwright）backend の最初のスライス（[BE-0041](../../implemented/BE-0041-web-playwright-backend/BE-0041-web-playwright-backend-ja.md)）は、
...
- **BE-0041 に差し戻す。** 却下します。BE-0041 はスライスを出荷済みで、現在は *実装済み* です。残った

...
# BE-XXXX — XCUITest live デバイスクラウド経路の実グリッド検証
...
経路を駆動します。このドライバモジュール自身の docstring は、両方とも「ネットワーク境界で fake化
...
- [BE-0237 — Firebase Test Lab / Device Streaming adapter](../BE-0237-firebase-device-streaming-adapter/BE-0237-firebase-device-streaming-adapter-ja.md)

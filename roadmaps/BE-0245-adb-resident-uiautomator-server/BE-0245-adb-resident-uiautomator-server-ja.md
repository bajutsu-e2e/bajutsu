...
| 実装 PR | [#1011](https://github.com/bajutsu-e2e/bajutsu/pull/1011)、[#1017](https://github.com/bajutsu-e2e/bajutsu/pull/1017) |
| トピック | プラットフォーム対応 |
...
- PR-B（[#1017](https://github.com/bajutsu-e2e/bajutsu/pull/1017)）— 常駐サーバ本体と、その配布方法の決定
  ...
  CI 配線は後続スライスへ延期します。
- PR-C（[#PENDING](https://github.com/bajutsu-e2e/bajutsu/pull/PENDING)）— Python 側のトランスポート

...
| 実装 PR | [#1011](https://github.com/bajutsu-e2e/bajutsu/pull/1011)、[#1017](https://github.com/bajutsu-e2e/bajutsu/pull/1017)、[#1032](https://github.com/bajutsu-e2e/bajutsu/pull/1032)、[#_pending_](https://github.com/bajutsu-e2e/bajutsu/pull/_pending_) |
| トピック | プラットフォーム対応 |
...
- PR-C（[#1032](https://github.com/bajutsu-e2e/bajutsu/pull/1032)）— Python 側のトランスポート
  ...
  ためこのボックスは未チェックのままです。
- PR-D ([#_pending_](https://github.com/bajutsu-e2e/bajutsu/pull/_pending_)) — 作業単位 5。チャネルを

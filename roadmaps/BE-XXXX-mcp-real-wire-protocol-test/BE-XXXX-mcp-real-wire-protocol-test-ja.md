[English](BE-XXXX-mcp-real-wire-protocol-test.md) · **日本語**
...
| 項目 | 値 |
|---|---|
| 提案 | [BE-XXXX](BE-XXXX-mcp-real-wire-protocol-test-ja.md) |
| 提案者 | [@0x0c](https://github.com/0x0c) |
| 状態 | **提案** |
| トラッキング Issue | [検索](https://github.com/bajutsu-e2e/bajutsu/issues?q=is%3Aissue+label%3Aroadmap-tracking+in%3Atitle+"BE-XXXX") |
| トピック | Integration & automation (MCP) |
<!-- /BE-METADATA -->
...
- **必須チェックとして着地させる**：ローカルな stdio の round-trip は外部サービスを必要とせず、
  既存のテストスイートを超えるフレーキーさのリスクも持ち込みません。したがってまず非 gating と
  して段階を踏む理由はありません。
...
- [ ] 実際の `bajutsu mcp` サーバプロセス(または実際の transport 上の in-process サーバ)を起動する。

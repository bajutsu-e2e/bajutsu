[English](BE-XXXX-shake-device-primitive.md) · **日本語**

# BE-XXXX — シェイクのデバイスプリミティブ

<!-- BE-METADATA -->
| 項目 | 値 |
|---|---|
| 提案 | [BE-XXXX](BE-XXXX-shake-device-primitive-ja.md) |
...
制御ステップと同様、[BE-0026](../../implemented/BE-0026-shrink-unsupported-syntax/BE-0026-shrink-unsupported-syntax-ja.md)
...
[BE-0052 — デバイス状態プリミティブ: タイムゾーン・クリップボード・シェイク](../../in-progress/BE-0052-device-state-timezone-clipboard-shake/BE-0052-device-state-timezone-clipboard-shake-ja.md)

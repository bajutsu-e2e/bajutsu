...
[BE-0054](../../in-progress/BE-0054-web-backend-completion/BE-0054-web-backend-completion-ja.md)（web backend の完成）に
...
- [BE-0054 Web backend の完成](../../in-progress/BE-0054-web-backend-completion/BE-0054-web-backend-completion-ja.md)：`<select>` 操作の置き場所

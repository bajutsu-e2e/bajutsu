**English** · [日本語](BE-0059-code-quality-gate-hardening-ja.md)

# BE-0059 — Code-quality gate hardening (CI fidelity, security lint, supply-chain)

* Proposal: [BE-0059](BE-0059-code-quality-gate-hardening.md)

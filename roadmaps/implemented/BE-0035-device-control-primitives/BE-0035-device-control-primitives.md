...
tracked separately in [Device-state primitives: timezone, clipboard, shake](../../proposals/BE-XXXX-device-state-timezone-clipboard-shake/BE-XXXX-device-state-timezone-clipboard-shake.md).

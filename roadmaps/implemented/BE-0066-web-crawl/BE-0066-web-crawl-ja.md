...
自律クロール（[BE-0038](../../in-progress/BE-0038-autonomous-crawl-exploration/BE-0038-autonomous-crawl-exploration-ja.md)）を
Web（Playwright）backend（[BE-0041](../../in-progress/BE-0041-web-playwright-backend/BE-0041-web-playwright-backend-ja.md)）へ広げ、
...
（[BE-0041](../../in-progress/BE-0041-web-playwright-backend/BE-0041-web-playwright-backend-ja.md)）。そのため web クロールを CI の
...
（[BE-0041](../../in-progress/BE-0041-web-playwright-backend/BE-0041-web-playwright-backend-ja.md)）になったのと同じ筋です。
...
**[BE-0054](../../in-progress/BE-0054-web-backend-completion/BE-0054-web-backend-completion-ja.md)（web backend の完成）を待つ.**
...
- [BE-0041 — Web（Playwright）backend](../../in-progress/BE-0041-web-playwright-backend/BE-0041-web-playwright-backend-ja.md)：web ドライバと、決定的な web の `run` 経路。
- [BE-0054 — Web backend の完成](../../in-progress/BE-0054-web-backend-completion/BE-0054-web-backend-completion-ja.md)：後の web クロールを豊かにするリッチな取得（network / video / 並列）。

...
to the Web (Playwright) backend ([BE-0041](../../in-progress/BE-0041-web-playwright-backend/BE-0041-web-playwright-backend.md)),
...
existing Linux `make check` / CI gate ([BE-0041](../../in-progress/BE-0041-web-playwright-backend/BE-0041-web-playwright-backend.md)),
...
item ([BE-0041](../../in-progress/BE-0041-web-playwright-backend/BE-0041-web-playwright-backend.md)) rather than an edit to `run`.
...
**Wait for [BE-0054](../../in-progress/BE-0054-web-backend-completion/BE-0054-web-backend-completion.md) (web backend
...
- [BE-0054 — Web backend completion](../../in-progress/BE-0054-web-backend-completion/BE-0054-web-backend-completion.md) — rich web capture (network / video / parallel) that enriches a web crawl later.

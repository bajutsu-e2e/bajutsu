...
- **シナリオ単位のストリーミング通知（各シナリオが終わるたびの ping）。** チャットチャンネルには騒がしすぎ、
  ライブ証跡のストリーミング
  （[BE-0070](../../proposals/BE-0070-live-run-artifacts-across-split/BE-0070-live-run-artifacts-across-split-ja.md)）と

...
- [BE-0067 — コード品質ゲートの強化](../../implemented/BE-0067-code-quality-gate-hardening/BE-0067-code-quality-gate-hardening-ja.md) — *Development infrastructure*（開発基盤）の下に置いた保守性項目の先例。

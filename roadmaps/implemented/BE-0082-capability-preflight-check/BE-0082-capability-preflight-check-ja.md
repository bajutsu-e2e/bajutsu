...
- **これは backend ごとの問題で、backend の組み合わせは増えていく。** iOS（idb）、Web（Playwright）があり、Android も計画されています（[BE-0009](../../in-progress/BE-0009-cross-platform-abstractions/BE-0009-cross-platform-abstractions-ja.md)）。backend
...
- [BE-0009 — Cross-platform abstractions](../../in-progress/BE-0009-cross-platform-abstractions/BE-0009-cross-platform-abstractions-ja.md)——`capabilities()`

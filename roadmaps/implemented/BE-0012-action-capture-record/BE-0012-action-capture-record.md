...
**Dependencies / related items:** [BE-0011](../../implemented/BE-0011-local-web-ui-serve/BE-0011-local-web-ui-serve.md) (the `serve` host, `ScenarioScope`, screenshot plumbing this extends), [BE-0013](../BE-0013-scenario-gui-editor/BE-0013-scenario-gui-editor.md) (shares the point → element picker + doctor score; the picker should be one shared component), [BE-0014](../../proposals/BE-0014-record-demarcation/BE-0014-record-demarcation.md) (the role demarcation vs the AI loop and the capture → assertion enrichment), [BE-0019](../../in-progress/BE-0019-xcuitest-backend/BE-0019-xcuitest-backend.md) (a future real event source behind the same resolver/emitter interface).

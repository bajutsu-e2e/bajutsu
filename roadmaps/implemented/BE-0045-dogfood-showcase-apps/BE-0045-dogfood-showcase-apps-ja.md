...
[BE-0006](../../in-progress/BE-0006-idb-element-tree-normalization/BE-0006-idb-element-tree-normalization-ja.md)）。
...
- [BE-0006](../../in-progress/BE-0006-idb-element-tree-normalization/BE-0006-idb-element-tree-normalization-ja.md) — idb 要素ツリー正規化（ツールキット軸が負荷をかける）

...
- **3 つ目の emitter を足せば 3 つ目のコピーになる。** Android の codegen 対象を追加するのは、Android backend が入ったあとの自然な次の一歩だが（[BE-0009](../../in-progress/BE-0009-cross-platform-abstractions/BE-0009-cross-platform-abstractions-ja.md)
...
- [BE-0009 — Cross-platform abstractions](../../in-progress/BE-0009-cross-platform-abstractions/BE-0009-cross-platform-abstractions-ja.md)——プラットフォームごとの表に、プラットフォームごとの新しい `codegen.py` emitter が挙がっている。この統一が役立つ将来の呼び出し側です。

...
* [BE-0066 — Web crawl (Playwright backend)](../BE-0066-web-crawl/BE-0066-web-crawl.md) — the serial web crawl this parallelizes; its reset seam, crash signals, and dialog handler carry over per worker.

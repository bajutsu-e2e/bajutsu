...
| Related | [BE-0107 — reach showcase tabs by navigation](../../proposals/BE-0107-showcase-tab-navigation-no-launch-shortcut/BE-0107-showcase-tab-navigation-no-launch-shortcut.md) |
| Origin | Dogfooding |
<!-- /BE-METADATA -->
...
- [x] Partial "no launch-time shortcut to a screen/state" — dropped `SHOWCASE_SEED` (the catalog is fixed) and the deeplink detail-push (a detail is reached only by tapping its row), both toolkits. Kept `SHOWCASE_TAB`: idb cannot tap a native tab bar, so switching tabs by tapping needs the XCUITest backend — deferred to [BE-0107](../../proposals/BE-0107-showcase-tab-navigation-no-launch-shortcut/BE-0107-showcase-tab-navigation-no-launch-shortcut.md) (reach showcase tabs by navigation, retiring `SHOWCASE_TAB`), which depends on BE-0019 maturing.

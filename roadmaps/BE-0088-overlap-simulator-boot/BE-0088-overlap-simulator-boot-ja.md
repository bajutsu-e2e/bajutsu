...
| 状態 | **実装済み** |
| トラッキング Issue | [検索](https://github.com/bajutsu-e2e/bajutsu/issues?q=is%3Aissue+label%3Aroadmap-tracking+in%3Atitle+"BE-0088") |
...
[BE-0087](../BE-0087-idb-action-settle/BE-0087-idb-action-settle-ja.md) の領域です。
...
- [BE-0087](../BE-0087-idb-action-settle/BE-0087-idb-action-settle-ja.md) — idb

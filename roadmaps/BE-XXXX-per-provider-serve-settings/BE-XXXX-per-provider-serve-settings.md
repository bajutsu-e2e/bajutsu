**English** · [日本語](BE-XXXX-per-provider-serve-settings-ja.md)

# BE-XXXX — Per-provider AI settings in the serve Web UI

<!-- BE-METADATA -->
| Field | Value |
|---|---|
| Proposal | [BE-XXXX](BE-XXXX-per-provider-serve-settings.md) |

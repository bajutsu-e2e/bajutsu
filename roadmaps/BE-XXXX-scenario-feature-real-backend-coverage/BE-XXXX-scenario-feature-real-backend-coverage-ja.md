...
- **BE-0281 の着地後に iOS へ拡張。** BE-0281 が iOS の実アクチュエーションを CI に配線したのち、同じ `extract` / `forEach` / data-driven / `relaunch` のシナリオを iOS でも走らせます。課金対象の macOS レーンとして、ゲート対象外で動かします。

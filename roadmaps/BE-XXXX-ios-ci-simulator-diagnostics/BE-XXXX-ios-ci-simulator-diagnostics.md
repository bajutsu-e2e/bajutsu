**English** · [日本語](BE-XXXX-ios-ci-simulator-diagnostics-ja.md)

# BE-XXXX — Collect the layered diagnostics an iOS CI failure needs

<!-- BE-METADATA -->
| Field | Value |
|---|---|
| Proposal | [BE-XXXX](BE-XXXX-ios-ci-simulator-diagnostics.md) |

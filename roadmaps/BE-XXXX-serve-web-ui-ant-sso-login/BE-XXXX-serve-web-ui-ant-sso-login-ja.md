...
- [x] テスト（ホスト 403、バイナリ欠如 400、起動 202、ステータス遷移、重複起動しないこと）と status オペレーション

ログ:

- [#705](https://github.com/bajutsu-e2e/bajutsu/pull/705)：機能を実装します。バックエンドのオペレーションと
  ルーティング、Settings のボタン、ドキュメント、テストです。この項目はロードマップと実装を独立して
  レビューできるよう、別の PR で作成しています。

**English** · [日本語](BE-XXXX-record-enrich-shared-replay-ja.md)

# BE-XXXX — Consolidate the duplicated replay helpers of record and enrich

<!-- BE-METADATA -->
| Field | Value |
|---|---|
| Proposal | [BE-XXXX](BE-XXXX-record-enrich-shared-replay.md) |

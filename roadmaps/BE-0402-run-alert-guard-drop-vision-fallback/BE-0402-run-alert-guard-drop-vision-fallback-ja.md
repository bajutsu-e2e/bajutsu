[English](BE-0402-run-alert-guard-drop-vision-fallback.md) · **日本語**

# BE-0402 — run のリアクティブなシステムアラートガードから AI vision フォールバックを廃止する
...
唯一のものです。黙って無視するより、はっきりエラーとして拒否するほうが、著者にとって親切です。

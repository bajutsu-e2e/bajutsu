[English](BE-0248-serve-state-decomposition-continued.md) · **日本語**

# BE-0248 — ServeState の分解を継続し、認証系とプロバイダー設定系のマネージャに分離する
...
| 実装 PR | [#1092](https://github.com/bajutsu-e2e/bajutsu/pull/1092) |
| トピック | コードベース品質・技術的負債 |
<!-- /BE-METADATA -->

...
| 実装 PR | [#673](https://github.com/bajutsu-e2e/bajutsu/pull/673) |
...
- [#673](https://github.com/bajutsu-e2e/bajutsu/pull/673) — 項目全体を出荷します。`lint_diagnostics`（行に紐づく診断。パースエラーは正確なマークを、

...
| Implementing PR | [#1799](https://github.com/bajutsu-e2e/bajutsu/pull/1799) |
...
- [x] 3. Record a project on every bind as the acting org's remembered configuration.
- [x] 4. Persist the active project per org in the database, and drop the `default`-org launch registration.

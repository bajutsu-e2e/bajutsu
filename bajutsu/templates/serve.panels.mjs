...
function initPanels(){
  ...
  $('#rec-go').addEventListener('click',async()=>{
    ...
    state.recPoll=await startJob({
      ...
      url:'/api/record',body:{
        ...
        erase:$('#rec-erase').checked,systemAlertHandling:$('#rec-nodismiss').checked?false:undefined,
  ...
  $('#rec-run').addEventListener('click',async()=>{
    ...
    const r=await fetch('/api/run',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({
      ...
      erase:$('#rec-erase').checked||undefined,systemAlertHandling:$('#rec-nodismiss').checked?false:undefined})});
  ...
  $('#go').addEventListener('click',async()=>{
    ...
    state.poll=await startJob({
      ...
      url:'/api/run',body:{
        ...
        erase:$('#erasedev').checked||undefined,systemAlertHandling:$('#nodismiss').checked?false:undefined},

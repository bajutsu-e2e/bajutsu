...
class AdbDriver(CoordinateTreeDriver):
    ...
    # alone — a longer budget would not have helped them, and their leading candidate, a read blind to
    # motion behind an element taller than the viewport, is what BE-0329's motion decisions address. From `smoke (adb)`'s intermittent `gestures` failure: a `swipe` moved the Log form

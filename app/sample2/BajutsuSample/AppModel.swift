...
final class AppModel: ObservableObject {
    ...
    private let signposter = OSSignposter(subsystem: "com.bajutsu.sample2", category: "actions")
    private let logger = Logger(subsystem: "com.bajutsu.sample2", category: "actions")
    ...
    func handleDeepLink(_ url: URL) {
        ...
        case "components", "controls", "text", "lists", "gestures", "presentation", "async", "system":
            screen = .home

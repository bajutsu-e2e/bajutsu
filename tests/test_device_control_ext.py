...
def test_home_cmd() -> None:
    from bajutsu.common.backend_cli.simctl import home_cmd
...
def test_status_bar_override_cmd() -> None:
    from bajutsu.common.backend_cli.simctl import status_bar_override_cmd
...
def test_status_bar_clear_cmd() -> None:
    from bajutsu.common.backend_cli.simctl import status_bar_clear_cmd

"""Tests for authoring-agent construction (bajutsu.common.agents.factory).
...
from bajutsu.common.agents.factory import make_agent, make_enrichment_agent
...
def test_make_enrichment_agent_builds_the_enrichment_agent() -> None:
    from bajutsu.common.agents.claude_enrich import ClaudeEnrichmentAgent

...
def test_path_topic_labels_maps_the_record_modules() -> None:
    # The record feature is the `record/` package (loop + CLI) plus its sibling top-level
    # `record_capture.py`; touching any of them lands topic:record so a reviewer can filter
    # record work off the PR list.

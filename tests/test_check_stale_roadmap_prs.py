...
def _seed_main_roadmap(roadmap: Path) -> None:
    ...
    d = roadmap / "proposals" / "BE-0042-existing"
...
def test_build_overlay_adds_a_new_placeholder(tmp_path: Path) -> None:
    ...
    build_overlay(
        ...
        dest,
        {
            "roadmaps/proposals/BE-XXXX-new-thing/BE-XXXX-new-thing.md": en,
            "roadmaps/proposals/BE-XXXX-new-thing/BE-XXXX-new-thing-ja.md": "ja\n",
        },
    )

    assert (dest / "proposals" / "BE-0042-existing" / "BE-0042-existing.md").is_file()
    added = dest / "proposals" / "BE-XXXX-new-thing" / "BE-XXXX-new-thing.md"
...
def test_build_overlay_deletes_a_removed_file(tmp_path: Path) -> None:
    ...
    build_overlay(
        main_roadmap, dest, {"roadmaps/proposals/BE-0042-existing/BE-0042-existing.md": None}
    )

    assert not (dest / "proposals" / "BE-0042-existing" / "BE-0042-existing.md").exists()
...
def test_detect_drift_is_clean_for_a_conformant_overlay(tmp_path: Path) -> None:
    ...
    problems = detect_drift(
        main_roadmap,
        {
            "roadmaps/proposals/BE-XXXX-fine-thing/BE-XXXX-fine-thing.md": en,
            "roadmaps/proposals/BE-XXXX-fine-thing/BE-XXXX-fine-thing-ja.md": "placeholder ja body\n",
        },
    )
...
def test_detect_drift_catches_a_missing_progress_section(tmp_path: Path) -> None:
    ...
    problems = detect_drift(
        main_roadmap,
        {
            "roadmaps/proposals/BE-XXXX-stale-thing/BE-XXXX-stale-thing.md": en,
            "roadmaps/proposals/BE-XXXX-stale-thing/BE-XXXX-stale-thing-ja.md": "placeholder ja body\n",
        },
    )
...
def test_compute_fixes_only_includes_changed_files() -> None:
    ...
    fixes = compute_fixes(
        {
            "roadmaps/proposals/BE-XXXX-a/BE-XXXX-a.md": conformant,
            "roadmaps/proposals/BE-XXXX-b/BE-XXXX-b.md": drifted,
            "roadmaps/proposals/BE-XXXX-c/BE-XXXX-c.md": None,  # deleted — skipped
        }
    )
    assert set(fixes) == {"roadmaps/proposals/BE-XXXX-b/BE-XXXX-b.md"}
    assert "## Progress" in fixes["roadmaps/proposals/BE-XXXX-b/BE-XXXX-b.md"]

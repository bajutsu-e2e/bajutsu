...
from bajutsu.common.agents.claude import TOOLS, ClaudeAgent, proposal_from_call
...
def test_system_prompt_teaches_the_bypass_field() -> None:
    ...
    from bajutsu.common.agents.claude import SYSTEM_PROMPT
...
def test_text_only_turn_with_vision_available_invites_need_screenshot() -> None:
    ...
    from bajutsu.common.agents.claude import _render
...
def test_plan_decomposes_goal_into_steps() -> None:
    ...
    from bajutsu.common.agents.claude import PLAN_TIMEOUT_S
...
def test_large_screen_collapses_only_the_non_addressable_remainder() -> None:
    from bajutsu.common.agents.claude import _LARGE_SCREEN_ELEMENTS, _render
